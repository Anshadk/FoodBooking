  ...
  public render(): void {
    ...
    <section class="${styles.webpart1} ${!!this.context.sdks.microsoftTeams ? styles.teams : ''}">
      <div class="${styles.welcome}">
        ...
        <h2>${_message}, ${escape(this.context.pageContext.user.displayName)}!</h2>
        ...
        <p class="${styles.welcome}">Server URL:${escape(this.context.pageContext.web.serverRelativeUrl)}</p>
